namespace Ordering.Domain.Models
{
    public class Order : Aggregate<OrderId>
    {
        ...
        public void Update(
            OrderName orderName, Address shippingAddress, Address billingAddress, Payment payment)
        {
            OrderName = orderName;
            ShippingAddress = shippingAddress;
            BillingAddress = billingAddress;
        ...
        {
            ArgumentOutOfRangeException.ThrowIfNegativeOrZero(quantity, "Quantity must be greater than zero.");
            ArgumentOutOfRangeException.ThrowIfNegativeOrZero(price, "Price must be greater than zero.");
